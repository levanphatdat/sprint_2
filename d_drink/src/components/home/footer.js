          ...
          <div className="row" style={{ margin: 0, padding: 0 }}>
            <div className="col-lg-3 col-sm-6">
              <div className="single-box">
                ...
                />
                <p>
                  Đăng kí nhận thông tin ưu đãi hàng tuần của chúng tôi để kịp
                  thời tham gia các chương trình hấp dẫn.{" "}
                </p>
                <h3>We Accect</h3>
              </div>
            </div>
            <div className="col-lg-3 col-sm-6">
              <div className="single-box">
                ...
                <ul>
                  ...
                  <li>
                    <a href="#">Số điện thoại: 1900 1009</a>
                  </li>
                  <li>
                    <a href="#">Email: info@vuabia.com</a>
                  </li>
                </ul>
              </div>
            </div>
            <div className="col-lg-3 col-sm-6">
              <div className="single-box">
                ...
                <ul>
                  <li>
                    <a href="#">Lê Văn Phát Đạt</a>
                  </li>
                  <li>
                    <a href="#">0971123432</a>
                  </li>
                  <li>
                    <a href="#">levanphatdat9@gmail.com</a>
                  </li>
                  <li>
                    <a href="#">Liên Chiểu, Cẩm Lệ, Đà Nẵng</a>
                  </li>
                </ul>
              </div>
            </div>
            <div className="col-lg-3 col-sm-6">
              <div className="single-box">
                ...
                <p>
                  Vui lòng nhập email | hoặc số điện thoại | hoặc Facebook của
                  bạn tại ô dưới đây:
                </p>
